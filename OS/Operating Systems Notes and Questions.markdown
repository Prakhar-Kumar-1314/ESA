...
#### 4-Mark Questions
1. **What are the key attributes of a file, and why are they important?**
...
2. **Explain the difference between sequential and direct access methods with examples.**
...
3. **Describe the role of the open-file table in file operations.**
...
4. **What are the advantages of a tree-structured directory over a single-level directory?**
...
#### 6-8-Mark Questions
1. **Discuss the various directory structures in file systems, highlighting their pros and cons.**
...
2. **Explain file system mounting with an example. Why is it necessary?**
...
3. **Describe protection mechanisms in Unix file systems, including permissions and setuid.**
...
#### 4-Mark Questions
1. **What is the purpose of disk partitioning?**
...
3. **Describe the FCFS disk scheduling algorithm.**
...
4. **Why is RAID 5 preferred for large data storage?**
...
#### 6-8-Mark Questions
1. **Compare SSTF and SCAN disk scheduling algorithms with an example.**
...
2. **Explain RAID levels 1, 5, and 10, highlighting their use cases.**
...
3. **Solve: Calculate total head movement for SSTF with queue 98, 183, 37, 122, 14, 124, 65, 67, head at 53.**
...
- **Visualization (Indexed Allocation)**:
  ```
...
#### 4-Mark Questions
1. **What is contiguous allocation, and what are its drawbacks?**
...
2. **Explain the bit vector method for free space management.**
...
3. **How does linked allocation differ from indexed allocation?**
...
4. **What is the purpose of free space management in file systems?**
...
#### 6-8-Mark Questions
1. **Compare contiguous, linked, and indexed allocation methods with examples.**
...
2. **Explain free space management techniques, highlighting their suitability.**
...
3. **Solve: For a 5-block file using indexed allocation, describe the allocation process if blocks 10, 20, 30, 40, 50 are free.**
...
#### 4-Mark Questions
1. **What is swap space, and why is it used?**
...
2. **How does Linux manage swap space?**
...
3. **What is the role of swap maps in swap space management?**
...
4. **Why might a system run out of swap space?**
...
#### 6-8-Mark Questions
1. **Explain swap space management in 4.3BSD and Solaris 2.**
...
2. **Discuss the advantages and challenges of using swap space.**
...
3. **Solve: If a system has 4 GB RAM and 8 GB swap space, how does it handle a 10 GB process?**
...
#### 4-Mark Questions
1. **What is the principle of least privilege in protection?**
...
2. **Explain Unix file permissions with an example.**
...
3. **What is an access control list (ACL) in file systems?**
...
4. **Name two security threats and their defenses.**
...
#### 6-8-Mark Questions
1. **Discuss the access matrix model for protection with an example.**
...
2. **Explain how Unix and Windows handle file protection differently.**
...
3. **Describe security threats and defenses in operating systems.**
